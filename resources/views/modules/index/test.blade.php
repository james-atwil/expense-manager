        ...
        <div class="page-header" id="banner">
            <div class="row">
                <div class="col-lg-8 col-md-7 col-sm-6">
                    <h1>GovCMS</h1>
                    <p class="lead">Content management system for Government Offices</p>
                </div>
            </div>
        </div>
        ...
        <div class="bs-docs-section">
            ...
            <div class="row">
                <div class="col">
                    ...
                    <p class="bs-component">
                        <button type="button" class="me-2 btn btn-primary disabled">Primary</button>
                        <button type="button" class="me-2 btn btn-secondary disabled">Secondary</button>
                        <button type="button" class="me-2 btn btn-success disabled">Success</button>
                        <button type="button" class="me-2 btn btn-info disabled">Info</button>
                        <button type="button" class="me-2 btn btn-warning disabled">Warning</button>
                        <button type="button" class="me-2 btn btn-danger disabled">Danger</button>
                        <button type="button" class="me-2 btn btn-link disabled">Link</button>
                    </p>
                    ...
                    <div class="bs-component">
                        <div class="me-2 btn-group" role="group" aria-label="Button group with nested dropdown">
                    ...
                    <div class="bs-component mt-3">
                        <button type="button" class="me-2 btn btn-primary btn-lg">Large button</button>
                        <button type="button" class="me-2 btn btn-primary">Default button</button>
                        <button type="button" class="me-2 btn btn-primary btn-sm">Small button</button>
                    </div>
                </div>
                <div class="col-lg-5">
                    <div class="bs-component">
        ...
        <div class="bs-docs-section">
            ...
            <div class="row">
                ...
                <div class="col-lg-6">
                    ...
                    <div class="bs-component mb-5">
                        <button type="button" class="btn btn-secondary" title="" data-bs-container="body"
                                data-bs-toggle="popover" data-bs-placement="left"
                                data-bs-content="Vivamus sagittis lacus vel augue laoreet rutrum faucibus."
                                data-bs-original-title="Popover Title">Left
                        </button>

                        <button type="button" class="btn btn-secondary" title="" data-bs-container="body"
                                data-bs-toggle="popover" data-bs-placement="top"
                                data-bs-content="Vivamus sagittis lacus vel augue laoreet rutrum faucibus."
                                data-bs-original-title="Popover Title">Top
                        </button>

                        <button type="button" class="btn btn-secondary" title="" data-bs-container="body"
                                data-bs-toggle="popover" data-bs-placement="bottom"
                                data-bs-content="Vivamus sagittis lacus vel augue laoreet rutrum faucibus."
                                data-bs-original-title="Popover Title">Bottom
                        </button>

                        <button type="button" class="btn btn-secondary" title="" data-bs-container="body"
                                data-bs-toggle="popover" data-bs-placement="right"
                                data-bs-content="Vivamus sagittis lacus vel augue laoreet rutrum faucibus."
                                data-bs-original-title="Popover Title">Right
                        </button>
                    </div>
                    <h2>Tooltips</h2>
            ...
            <button class=&quot;source-button btn btn-primary btn-xs&quot; role=&quot;button&quot; tabindex=&quot;0&quot;>&amp;lt; &amp;gt;</button>">
                        <button type="button" class="btn btn-secondary" data-bs-toggle="tooltip"
                                data-bs-placement="left" title="" data-bs-original-title="Tooltip on left">Left
                        </button>

                        <button type="button" class="btn btn-secondary" data-bs-toggle="tooltip" data-bs-placement="top"
                                title="" data-bs-original-title="Tooltip on top">Top
                        </button>

                        <button type="button" class="btn btn-secondary" data-bs-toggle="tooltip"
                                data-bs-placement="bottom" title="" data-bs-original-title="Tooltip on bottom">Bottom
                        </button>

                        <button type="button" class="btn btn-secondary" data-bs-toggle="tooltip"
                                data-bs-placement="right" title="" data-bs-original-title="Tooltip on right">Right
                        </button>
                    </div>
                    <h2>Toasts</h2>
                    <div class="bs-component">
...
@section('javascript'){!!  '<script src="' . asset('js/modules/index/test.js') . '"></script>' !!}@endsection
