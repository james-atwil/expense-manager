...
@section('title')
   Categories {{ ts() }} Expenses Management
@endsection
...
@section('content')
            ...
            <div class="modal-content">
                <v-form ref="mainForm" @submit="actions.submit" :validation-schema="schema" :initial-values="record">
                    <div class="modal-header bg-primary text-white">
                        <h5 class="modal-title" id="modal-form-title"> @{{ record.id > 0 ? 'Edit' : 'Add' }} Category</h5>
    ...
    <div class="modal fade" id="modal-delete" data-bs-backdrop="static" tabindex="-1" role="dialog" aria-labelledby="modal-delete-title" aria-hidden="true">
        <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content">
                <div class="modal-header bg-primary text-white">
                    <h5 class="modal-title" id="modal-form-title"> Delete Category</h5>
                    <button type="reset" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                </div>
                <div class="modal-body">
                    Are you sure that you will delete the Category named <strong>@{{ record.name }}</strong>?
                </div>
                <div class="modal-footer">
...
@section('javascript')
    {!!  '<script src="' . asset('js/modules/expenses/categories/index.js') . '"></script>' !!}
@endsection
