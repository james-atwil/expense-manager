"use strict";
(self["webpackChunk"] = self["webpackChunk"] || []).push([["/js/modules/expenses/categories/index"],{
...
/***/ "./resources/js/modules/expenses/categories/index.js":
/*!***********************************************************!*\
  !*** ./resources/js/modules/expenses/categories/index.js ***!
  \***********************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony import */ var _components_Overlay__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ../../../components/Overlay */ "./resources/js/components/Overlay.vue");
...
var IndexComponent = {
  components: {
    TOverlay: _components_Overlay__WEBPACK_IMPORTED_MODULE_6__["default"],
    TToasts: _components_Toasts__WEBPACK_IMPORTED_MODULE_2__["default"],
    VForm: vee_validate__WEBPACK_IMPORTED_MODULE_10__.Form,
    ...
    TButton: _components_Button__WEBPACK_IMPORTED_MODULE_5__["default"]
  },
  setup: function setup() {
    var service = new _services_expenses_service__WEBPACK_IMPORTED_MODULE_1__.CategoryService();
    var names = {
      singular: 'Category',
      plural: 'Categories'
    };
    var schema = yup__WEBPACK_IMPORTED_MODULE_8__.object({
      name: yup__WEBPACK_IMPORTED_MODULE_8__.string().nullable().required('Field is required.')
    });
    ...
    var listDown = /*#__PURE__*/function () {
          ...
          while (1) {
            switch (_context.prev = _context.next) {
              ...
              case 3:
                ...
                if (romeo instanceof _services_errors__WEBPACK_IMPORTED_MODULE_7__["default"]) {
                  if (toasts !== null) {
    ...
    var actions = {
      ...
      submit: function () {
        var _submit = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee2(values, _ref2) {
            ...
            while (1) {
              switch (_context2.prev = _context2.next) {
                case 0:
                  ...
                  _context2.next = 4;
                  return service.save(record.value);
            ...
            while (1) {
              switch (_context3.prev = _context3.next) {
                case 0:
                  states.submitting = true;
                  _context3.next = 3;
                  return service.destroySingle(record.value);
      ...
      return _regeneratorRuntime().wrap(function _callee4$(_context4) {
        while (1) {
          switch (_context4.prev = _context4.next) {
            case 0:
              formModal = bootstrap__WEBPACK_IMPORTED_MODULE_9__.Modal.getOrCreateInstance(document.getElementById('modal-form'));
              deleteModal = bootstrap__WEBPACK_IMPORTED_MODULE_9__.Modal.getOrCreateInstance(document.getElementById('modal-delete'));
              _context4.next = 4;
              return listDown();
...
/******/ __webpack_require__.O(0, ["/js/vendor"], () => (__webpack_exec__("./resources/js/modules/expenses/categories/index.js")));
