"use strict";
(self["webpackChunk"] = self["webpackChunk"] || []).push([["/js/modules/system/users/profile"],{
...
/***/ "./resources/js/modules/system/users/profile.js":
/*!******************************************************!*\
  !*** ./resources/js/modules/system/users/profile.js ***!
  \******************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
var IndexComponent = {
  ...
  setup: function setup() {
    ...
    var schema = yup__WEBPACK_IMPORTED_MODULE_10__.object({
      password: yup__WEBPACK_IMPORTED_MODULE_10__.string().required('Field is required.')
    });
    ...
    var actions = {
      submit: function () {
        var _submit = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(values, _ref) {
            ...
            while (1) {
              switch (_context.prev = _context.next) {
                case 0:
                  ...
                  _context.next = 4;
                  return userService.changePass(record.value);
...
/******/ __webpack_require__.O(0, ["/js/vendor"], () => (__webpack_exec__("./resources/js/modules/system/users/profile.js")));
