"use strict";
(self["webpackChunk"] = self["webpackChunk"] || []).push([["/js/modules/system/users/index"],{
...
/***/ "./resources/js/modules/system/users/index.js":
/*!****************************************************!*\
  !*** ./resources/js/modules/system/users/index.js ***!
  \****************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var vue__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! vue */ "./node_modules/vue/dist/vue.esm-bundler.js");
/* harmony import */ var _services_system_service__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../../../services/system/service */ "./resources/js/services/system/service.js");
...
var IndexComponent = {
  ...
  setup: function setup() {
    var roleService = new _services_system_service__WEBPACK_IMPORTED_MODULE_1__.RoleService();
    var userService = new _services_system_service__WEBPACK_IMPORTED_MODULE_1__.UserService();
    var names = {
      singular: 'User',
      plural: 'Users'
    };
    ...
    var emailExists = function emailExists(value) {
      if (value === '' || value === null || value === undefined) {
        return true;
      }

      return new Promise(function (resolve, reject) {
        userService.exists(record.value.id, 'email', value).then(function (response) {
          if (response instanceof _services_errors__WEBPACK_IMPORTED_MODULE_9__["default"]) {
            toasts.post('danger', response.message);
            resolve(new yup__WEBPACK_IMPORTED_MODULE_10__.ValidationError('Error encountered on remote validation.'));
          }
    ...
    var schema = yup__WEBPACK_IMPORTED_MODULE_10__.object({
      name_display: yup__WEBPACK_IMPORTED_MODULE_10__.string().nullable().required('Field is required.'),
      password: yup__WEBPACK_IMPORTED_MODULE_10__.string().nullable().when('id', {
        is: function is(val) {
      ...
      email: yup__WEBPACK_IMPORTED_MODULE_10__.string().nullable().email('Invalid email address.').required('Field is required.').test('email-exists', 'Email address is already taken.', emailExists),
      role: yup__WEBPACK_IMPORTED_MODULE_10__.object().nullable().required('Field is required.')
    });
    ...
    var listDownRoles = /*#__PURE__*/function () {
          ...
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                states.loading = true;
                _context.next = 3;
                return roleService.list('l=0&m=1');
      ...
      return function listDownRoles() {
        return _ref.apply(this, arguments);
      };
    }();

    var listDownUsers = /*#__PURE__*/function () {
    ...
    var actions = {
      ...
      edit: function () {
        var _edit = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee3(romeo) {
      ...
      submit: function () {
        var _submit = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee4(values, _ref3) {
            ...
            while (1) {
              switch (_context4.prev = _context4.next) {
                case 0:
                  ...
                  _context4.next = 4;
                  return userService.save(record.value);
            ...
            while (1) {
              switch (_context5.prev = _context5.next) {
                case 0:
                  states.submitting = true;
                  _context5.next = 3;
                  return userService.destroySingle(record.value);
...
/******/ __webpack_require__.O(0, ["/js/vendor"], () => (__webpack_exec__("./resources/js/modules/system/users/index.js")));
